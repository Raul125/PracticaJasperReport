...
public class TripulantesController extends Controller {
    private NaveTableModel supplierTableModel;
    ...
    public void setupButtons() {
        mainController.view.suppliersAdd.addActionListener(e -> {
            ...
            if (mainController.model.checkSupplierExists(mail, -1)) {
        ...
        mainController.view.suppliersModify.addActionListener(e -> {
            ...
            int id = (int) mainController.view.suppliersTable.getValueAt(row, 0);
            String mail = mainController.view.supplierMail.getText();
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                ...
                if (evt.getClickCount() == 2) {
                    ...
                    if (row != -1) {
                        ...
                        StockDialog stockDialog = new StockDialog(mainController.view, supplier);
    ...
    public void refreshTable() {
        try {
            supplierTableModel = new NaveTableModel(mainController.model.getSuppliers());
    ...
    public void refreshComboBox() {
        ...
        for (Supplier supplier : supplierTableModel.getNaves()) {
